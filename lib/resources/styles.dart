...
abstract class Palette {
  ...
  static const Color gray = Color(0xFF494949);
  static const Color yellow = Color(0xFFF9A000);
...
abstract class TextStyles {
  ...
  static final TextStyle textSize16Weight500 = TextStyle(
    fontSize: 16.sp,
    fontWeight: FontWeight.w500,
  );
  ...
  static final TextStyle textSize20Weight500 = TextStyle(
    fontSize: 20.sp,
    fontWeight: FontWeight.w500,
  );
